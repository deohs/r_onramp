...
* SPH IT is preparing a server for SPH use (all depts.), but it's not ready yet.
* DEOHS runs RStudio Server on "Plasmid", a Linux virtual machine.
   ...
   - Access directy from UW Campus or remotely through [Husky OnNet VPN](https://itconnect.uw.edu/connect/uw-networks/about-husky-onnet/).
