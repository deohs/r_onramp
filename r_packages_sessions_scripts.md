...
* How to save and load your R session
* How an R session is stored
* How to read and write data files
* How to edit, save, and run R scripts
...
After saving and closing your script you can open it and re-run it at a later 
time, or send it to someone to run themselves.

To run a whole script you can press the "Run" button at the top left of the 
Source pane.

To go line-by-line put the cursor next to a line and press*:
      
      [Ctrl] + [Enter]

To run a multiple lines, highlight the desired lines and press*:
